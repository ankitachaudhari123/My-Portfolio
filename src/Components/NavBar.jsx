    ...
    <>
      <div className='nav-bar-box-web'>
        <ul>
          <br></br>
          <br></br>
          <a href='#home' className='a-hrf' onClick={handleNavLinkClick}><li className='nav-bar-items'><IoHome size="15px" />  Home</li></a>
          <a href='#about' className='a-hrf' onClick={handleNavLinkClick}><li className='nav-bar-items'><FaUser size="15px" />  About</li></a>
          <a href='#project' className='a-hrf' onClick={handleNavLinkClick}><li className='nav-bar-items'><FaLaptopCode size="15px" />  Project</li></a>
          <a href='#experience' className='a-hrf' onClick={handleNavLinkClick}><li className='nav-bar-items'><FaAward size="15px" />  Experience</li></a>
          <a href='#contact' className='a-hrf' onClick={handleNavLinkClick}><li className='nav-bar-items'><FaPhone size="15px" />  Contact</li></a>
        </ul>
        <h5 className='nav-bar-text'>Socials</h5>
        <ul>
          <a href='https://www.linkedin.com/in/ankita-chaudhari-6650b3273/' className='a-hrf'><li className='nav-bar-social-items'><IoLogoLinkedin size="20px" />  Linkedin</li></a>
